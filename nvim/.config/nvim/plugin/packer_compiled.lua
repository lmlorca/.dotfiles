...
_G.packer_plugins = {
  LuaSnip = {
    loaded = true,
    path = "/home/lmlorca/.local/share/nvim/site/pack/packer/start/LuaSnip",
    url = "https://github.com/L3MON4D3/LuaSnip"
  },
  ["candle-grey"] = {
    loaded = true,
    path = "/home/lmlorca/.local/share/nvim/site/pack/packer/start/candle-grey",
    url = "https://github.com/aditya-azad/candle-grey"
  },
  ["cmp-nvim-lsp"] = {
    loaded = true,
    path = "/home/lmlorca/.local/share/nvim/site/pack/packer/start/cmp-nvim-lsp",
    url = "https://github.com/hrsh7th/cmp-nvim-lsp"
  },
  ["lsp-zero.nvim"] = {
    loaded = true,
    path = "/home/lmlorca/.local/share/nvim/site/pack/packer/start/lsp-zero.nvim",
    url = "https://github.com/VonHeikemen/lsp-zero.nvim"
  },
  ["mason-lspconfig.nvim"] = {
    loaded = true,
    path = "/home/lmlorca/.local/share/nvim/site/pack/packer/start/mason-lspconfig.nvim",
    url = "https://github.com/williamboman/mason-lspconfig.nvim"
  },
  ["mason.nvim"] = {
    loaded = true,
    path = "/home/lmlorca/.local/share/nvim/site/pack/packer/start/mason.nvim",
  ...
  ["no-clown-fiesta.nvim"] = {
    loaded = true,
    path = "/home/lmlorca/.local/share/nvim/site/pack/packer/start/no-clown-fiesta.nvim",
    url = "https://github.com/aktersnurra/no-clown-fiesta.nvim"
  },
  ["nvim-autopairs"] = {
    loaded = true,
    path = "/home/lmlorca/.local/share/nvim/site/pack/packer/start/nvim-autopairs",
    url = "https://github.com/windwp/nvim-autopairs"
  },
  ["nvim-cmp"] = {
    loaded = true,
    path = "/home/lmlorca/.local/share/nvim/site/pack/packer/start/nvim-cmp",
  ...
  ["nvim-ts-autotag"] = {
    loaded = true,
    path = "/home/lmlorca/.local/share/nvim/site/pack/packer/start/nvim-ts-autotag",
